...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__142F14E",
    appName: "take-things-page",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
const pages = [
  ...
  {
    path: "pages/other/about/about",
    style: {
      navigationBarTitleText: "小熊代取介绍",
      navigationBarBackgroundColor: "#F8F8F8"
    }
  },
  {
    path: "pages/other/run/run",
    style: {
      navigationBarTitleText: "成为跑手",
      navigationBarBackgroundColor: "#F8F8F8"
    }
  },
  {
  ...
  {
    path: "pages/form-list/expressage/expressage",
    style: {
  ...
  {
    path: "pages/other/client/client",
    style: {
  ...
  {
    path: "pages/form-list/garbage/garbage",
    style: {
      navigationBarTitleText: "垃圾处理",
      navigationBarBackgroundColor: "#F8F8F8"
    }
  },
  {
    path: "pages/form-list/object/object",
    style: {
      navigationBarTitleText: "物件大小",
      navigationBarBackgroundColor: "#F8F8F8"
    }
  },
  {
...
const S = true, b = "mp-weixin", A = I([]), P = b, T = I('{\n    "address": [\n        "127.0.0.1",\n        "192.168.56.1",\n        "192.168.147.1",\n        "192.168.242.1",\n        "192.168.0.127"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "D:/hbuilder/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), C = I('[{"provider":"aliyun","spaceName":"take-things-cloud","spaceId":"mp-33420585-9183-4b24-8565-0e60180fbb5d","clientSecret":"h5WXaK2PP9DgYlBlmkbg8w=="}]') || [];
let O = "";
try {
  O = "__UNI__142F14E";
} catch (e2) {

...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const exitaddress = (res) => {
      api_address.updateaddress(id.value, res.name, res.phone, res.address).then((res2) => {
        console.log(res2);
        common_vendor.index.showToast({
          icon: "success",
          title: "修改成功"
    ...
    const addressmsg = (_id) => {
      ...
      api_address.getaddressbyid(_id).then((res) => {
    ...
    return (_ctx, _cache) => {
      return {
        ...
        j: common_vendor.sr("valiForm", "e49d78fc-0"),
        k: common_vendor.p({
          rules: rules.value,
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/HBuilderProjects/take-things-page/pages/address/exit/exit.vue"]]);
